...
const OrderSummary = ({
  ...
  return (
    <div className="m-4 text-lg font-semibold p-4 h-fit w-fit rounded-lg bg-gray-200 space-x-4 space-y-4">
      ...
      {window.location.href === "https://shop-vista-01.onrender.com/cart" && (
        <button
